...
append_metrics() {
  ...
  local agents_tried="${21:-}"  # Comma-separated list of agents tried
  local failure_type="${22:-}"  # timeout, error, quality, or empty
