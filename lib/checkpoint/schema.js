 ...
 * - plan_hash: SHA-256 hash of plan.md for validation (optional)
...
const CHECKPOINT_SCHEMA = {
  ...
  plan_hash: { type: "string", required: false },
  loop_state: {
    type: "object",
    required: false,
    properties: {
...
function createCheckpoint(data = {}) {
  ...
  // Add plan_hash if provided (optional field for validation)
  if (data.plan_hash) {
    checkpoint.plan_hash = data.plan_hash;
  }
