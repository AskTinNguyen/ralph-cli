...
${pc.bold("━━━ Core Workflow (PRD → Plan → Build) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
  ...
  ${pc.green("plan")} ${pc.dim("[n] [--prd=N]")}                    Create implementation plan from PRD
...
${pc.bold("━━━ Analytics & Estimation ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
  ...
  ${pc.green("budget set")} ${pc.dim("<amount> [--prd=N]")}        Set budget limit for builds
  ${pc.green("budget show")} ${pc.dim("[--prd=N]")}                Show budget status
  ${pc.green("budget clear")} ${pc.dim("[--prd=N]")}               Remove budget limit
...
${pc.bold("━━━ Project & Knowledge Management ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
  ...
  voiceCommands: `
${pc.bold("━━━ Voice & Text-to-Speech ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}

  ${pc.green("speak")} ${pc.dim("[\"<text>\"] [--auto-on|--auto-off|--auto-status]")} Speak text or manage auto-speak
  ${pc.green("recap")} ${pc.dim("[--full|--short|--preview]")}      Summarize and speak last response

  ${pc.dim("Auto-speak modes:")}
    ${pc.green("ralph speak --auto-on")}                Automatically speak responses (20-30 words)
    ${pc.green("ralph speak --auto-off")}               Disable automatic speaking
    ${pc.green("ralph speak --auto-status")}            Check if auto-speak is enabled

  ${pc.dim("Recap summaries (on-demand, longer):")}
    ${pc.green("ralph recap")}                          Medium summary (~100 words, default)
    ${pc.green("ralph recap --full")}                   Detailed summary (~200 words)
    ${pc.green("ralph recap --short")}                  Short summary (~30 words)
    ${pc.green("ralph recap --preview")}                Preview summary without speaking

  ${pc.dim("TTS Engine options:")}
    ${pc.green("ralph speak --get-tts-engine")}         Show current TTS engine
    ${pc.green("ralph speak --set-tts-engine")} ${pc.dim("<engine>")}  Set engine (macos|piper|vieneu)

  ${pc.dim("VieNeu-TTS (Vietnamese voice cloning):")}
    ${pc.green("ralph speak --list-vieneu-voices")}     List available VieNeu voices
    ${pc.green("ralph speak --set-vieneu-voice")} ${pc.dim("<v>")}   Set voice (Binh|Tuyen|Vinh|Doan|Ly|Ngoc)
    ${pc.green("ralph speak --engine vieneu")} ${pc.dim("\"text\"")}  Use VieNeu for one command

  ${pc.dim("Requirements: Ollama (Qwen), VieNeu-TTS (optional)")}
  ${pc.dim("See: AUTO-SPEAK-GUIDE.md for full setup instructions")}`,

  automation: `
${pc.bold("━━━ Executive Automation ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}

  ${pc.green("automation slack-report")}               Send team reports to Slack channels
  ${pc.green("automation check-blockers")}             Detect and escalate blocked PRDs
  ${pc.green("automation github-archive")}             Archive metrics to GitHub
  ${pc.green("automation scan-bugs")}                  Scan git history for bug commits
  ${pc.green("automation verify")}                     Check automation installation

  ${pc.dim("Configuration: .ralph/automation-config.json")}
  ${pc.dim("Environment: SLACK_BOT_TOKEN, GITHUB_TOKEN")}`,

  nightlyRecommendations: `
${pc.bold("━━━ Nightly AI Recommendations ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}

  ${pc.green("nightly run")} ${pc.dim("[--whatsapp]")}              Run analysis and send via WhatsApp
  ${pc.green("nightly config")}                        Interactive configuration setup
  ${pc.green("nightly schedule")} ${pc.dim("[--time HH:MM]")}       Set up automated scheduling
  ${pc.green("nightly status")}                        Show configuration and schedule status
  ${pc.green("nightly history")} ${pc.dim("[--limit N]")}           View past recommendations
  ${pc.green("nightly test")}                          Test configuration (dry run)

  ${pc.dim("Options:")}
    ${pc.yellow("--whatsapp")}               Send WhatsApp with GitHub link (via Mudslide)
    ${pc.yellow("--create-pr")}              Create PR with implementation
    ${pc.yellow("--auto-implement")}         Auto-implement recommendation

  ${pc.dim("Reports stored: docs/nightly/recommendations/ (accessible on GitHub)")}
  ${pc.dim("Environment: ANTHROPIC_API_KEY, WHATSAPP_TO")}`,
...
function generateFullHelp() {
  return [
    ...
    HELP_SECTIONS.automation,
    HELP_SECTIONS.nightlyRecommendations,
    HELP_SECTIONS.utilities,
    HELP_SECTIONS.voiceCommands,
