...
${pc.bold("━━━ Nightly AI Recommendations ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
  ...
  ${pc.green("nightly run")} ${pc.dim("[--email] [--slack]")}       Run analysis and generate recommendation
  ...
  ${pc.dim("Options:")}
    ...
    ${pc.yellow("--method")} ${pc.dim("<cron|launchd|github-actions>")}  Scheduling method

  ${pc.dim("Environment: ANTHROPIC_API_KEY, DATABASE_URL, SMTP_HOST")}`,
