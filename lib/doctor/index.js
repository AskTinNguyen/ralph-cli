...
function runAllChecks(projectPath = ".") {
  ...
  const results = {
    ...
    state: stateResults,
    summary: {
      totalPassed: envResults.passed + configResults.passed + stateResults.passed,
      totalWarnings: envResults.warnings + configResults.warnings + stateResults.warnings,
      totalErrors: envResults.errors + configResults.errors + stateResults.errors,
    },
  };
