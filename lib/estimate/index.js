...
function estimate(options = {}) {
  ...
  for (const story of plan.stories) {
    ...
    const storyEstimate = {
      ...
      complexityLevel: historyEstimate.complexity ? historyEstimate.complexity.complexityLevel : "medium",
  ...
  const avgHistoricalSamples = plan.stories.length > 0
    ? Math.round(totalHistoricalSamples / plan.stories.length)
    : 0;
