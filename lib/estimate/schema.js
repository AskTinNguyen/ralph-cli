...
// Routing data for learning from outcomes (US-004)
  ...
  rollbackCount: { type: "number", required: false, nullable: true },
  rollbackReason: { type: "string", required: false, nullable: true },
  rollbackSuccess: { type: "boolean", required: false, nullable: true },
...
// Routing data for learning from outcomes (US-004)
    ...
    // Rollback tracking fields (US-004)
    rollbackCount: data.rollbackCount != null ? data.rollbackCount : null,
    rollbackReason: data.rollbackReason || null,
    rollbackSuccess: data.rollbackSuccess != null ? data.rollbackSuccess : null,
  };
