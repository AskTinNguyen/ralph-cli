...
module.exports = {
  ...
  // Analysis exports
  normalCDF: analysis.normalCDF,
  zToPValue: analysis.zToPValue,
  variance: analysis.variance,
  calculateSignificance: analysis.calculateSignificance,
  calculateDurationSignificance: analysis.calculateDurationSignificance,
  determineWinner: analysis.determineWinner,
  analyzeExperiment: analysis.analyzeExperiment,
  exportAsJSON: analysis.exportAsJSON,
  exportAsCSV: analysis.exportAsCSV,
  formatForTerminal: analysis.formatForTerminal,
  asciiBar: analysis.asciiBar,
