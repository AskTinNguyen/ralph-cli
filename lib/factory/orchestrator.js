...
class FactoryOrchestrator extends EventEmitter {
  ...
  constructor(factory, projectRoot, runDir, options = {}) {
    ...
    // Variables are nested under 'variables' key to match YAML structure
    // e.g., {{ variables.user_request }} accesses context.variables.user_request
    this.context = {
      ...
      // Also spread variables at top level for backwards compatibility
      ...options.variables
    };
