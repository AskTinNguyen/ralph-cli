...
## ${priorityEmoji[recommendation?.priority] || "💡"} Recommendation

### ${recommendation?.title || "Action Item"}

**Priority:** ${recommendation?.priority?.toUpperCase() || "MEDIUM"}
**Effort:** ${effortEmoji[recommendation?.effort] || "🟡"} ${recommendation?.effort?.toUpperCase() || "MEDIUM"}
...
${(analysis?.concerningTrends || []).map(t => `- ⚠️ ${t}`).join("\n") || "- No concerning trends identified"}
  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <ul class="data-points">
        ${(recommendation?.dataPoints || ["No specific data points"]).map(d => `<li>📊 ${d}</li>`).join("")}
      </ul>
    </div>
    ...
    <div class="section">
      ...
      <div class="insights">
        ${analysis.keyInsights.map(i => `<div class="insight">💡 ${i}</div>`).join("")}
      </div>
    </div>
    ` : ""}
    ...
    <div class="footer">
      <p>Generated by Ralph CLI • ${dateStr}</p>
    ...
    blocks: [
      {
        ...
        text: {
          type: "plain_text",
          text: `${priorityEmoji[recommendation?.priority] || "💡"} ${recommendation?.title || "Daily Recommendation"}`,
        },
      },
      {
        type: "section",
